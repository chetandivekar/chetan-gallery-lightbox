...
export const Gallery = ({
  ...
  const handleImageClick = (_: any, index: number) => {
        ...
        <div className="w-[100vw] h-[40vh] lg:w-[70vw] lg:h-[60vh] flex items-center gap-3 ">
          ...
          <div className="h-[100%] w-[100%]">
            <div className="flex justify-between bg-white">
              <div className="px-4 text-black py-1">
                {selectedImageIndex + 1} / {imagesArray.length}
              </div>
              <button
                className="px-4 bg-white text-black border-none focus:outline-none py-1"
                onClick={() => {
                  setModalOpen(false);
                }}
              >
